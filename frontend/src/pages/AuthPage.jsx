      ...
      <div className="relative z-10 w-full max-w-lg">
        <div className="bg-surface-container-lowest dark:bg-stone-900 rounded-xl shadow-2xl shadow-on-surface/5 border-t-8 border-primary-container overflow-hidden">
          ...
          <div className="flex bg-surface-container-low dark:bg-stone-800">
            {[['Login', 'login'], ['Sign Up', 'signup']].map(([label, val]) => (
              <button
                key={val}
                onClick={() => setTab(val)}
              ...
              <form className="space-y-6" onSubmit={handleLogin}>
                ...
                <div className="space-y-4">
                  ...
                  <div className="space-y-1">
                    <div className="flex justify-between items-center px-1">
                      <label className="text-xs font-bold uppercase tracking-widest text-stone-500 font-body">Password</label>
                ...
                <div className="relative py-4">
                  ...
                  <div className="relative flex justify-center text-xs uppercase tracking-widest font-bold">
                    <span className="bg-surface-container-lowest dark:bg-stone-900 px-4 text-stone-400 font-body">or continue with</span>
                  </div>
                </div>
              ...
              <form className="space-y-5" onSubmit={handleSignup}>
                ...
                <div className="flex items-start gap-3 px-1">
                  ...
                  <label className="text-xs text-stone-500 leading-tight font-body">
                    ...
                    {' '}and{' '}
                    <a href="#" className="text-primary-container font-semibold hover:underline">Privacy Policy</a>.
                  </label>
                </div>
